<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
                <img height="68" src="https://i.ibb.co/D1gTt27/th.png" class="header-brand-img" title="RADMIN">
            </div>
        </a>
        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'pricing') ? 'active' : '' }}">
                    <a href="{{url('pricing')}}"><i class="ik ik-dollar-sign"></i><span>{{ __('Pricing')}}</span><span
                            class=" badge badge-success badge-right">{{ __('New')}}</span></a>
                </div>
                ...
                @if (auth()->user()->role == 1)
                @include('include.sidebar.Leader')
                @elseif (auth()->user()->role == 2)
                @include('include.sidebar.Company')
                @elseif (auth()->user()->role == 3)
                @include('include.sidebar.Employee')
