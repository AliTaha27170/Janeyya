            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title left">
                        ...
                        <div class="d-inline ">
                            <h5>الدلالون   </h5>
                            <span>العدد الكلي : {{ count($users) }}  دلال  </span>
                        </div>
                        <br> <br>
                        <div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ar">
                        ...
                        <h3 > <a class="big-font add" href="{{ route('addDalal') }}">إضافة دلال جديد  <i class="ik ik-file-plus big-font big"></i></a></h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                ...
                                                <a href="{{ route('editDalal',$user->id) }}"><i class="ik ik-edit-2"></i></a>
                                                <a href="{{ route('deleteDalal',$user->id) }}" onclick="return confirm('هل أنت متأكد من ذلك ؟ ')"><i class="ik ik-trash-2"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
