            ...
            <div class="col-md-12 big-font ar" >
                <div class="card ">
                    ...
                    <div class="card-header">
                        ...
                        <img src="https://i.ibb.co/YyjQJfK/edit-document-save-search-office-pencil-exit-512.png" width="65px" border="0" class="img_">
                        <h3>الكتاب     </h3>
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST"
                         ...
                         action="{{ isset($user)? route('updateWriter',$user->id) : route('storeWriter') }}" 
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td>
                                                        ...
                                                        <label for="name">اسم الكاتب    <span class="text-red">*</span></label>
