            ...
            <div class="col-md-12 big-font ar" >
                <div class="card ">
                    ...
                    <div class="card-header">
                        ...
                        <img src="https://i.ibb.co/P5sdFy8/man-avatar-arab-user-people-male-islam-512.png" width="45px" border="0" class="img_">
                        <h3>التٌجار   </h3>
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST"
                         ...
                         action="{{ isset($user)? route('updateDealer',$user->id) : route('storeDealer') }}" 
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td>
                                                        ...
                                                        <label for="name">اسم التاجر  <span class="text-red">*</span></label>
                                                ...
                                                <td>
                                                        ...
                                                        <label for="name">اسم المؤسسة   <span class="text-red">*</span></label>
                                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="company_name" value="{{ isset($user) ? $user->company_name : '' }}"placeholder="المؤسسة" required>
                                                        <div class="help-block with-errors"></div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name">موقع  المؤسسة   <span class="text-red">*</span></label>
                                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="adress" value="{{ isset($user) ? $user->adress : '' }}" placeholder="الموقع " required>
                                                        <div class="help-block with-errors"></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name">رقم السجل التجاري     <span class="text-red">*</span></label>
                                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="CommercialRegistrationNo" value="{{ isset($user) ? $user->CommercialRegistrationNo : '' }}" placeholder=" رقم السجل" required>
                                                        <div class="help-block with-errors"></div>
