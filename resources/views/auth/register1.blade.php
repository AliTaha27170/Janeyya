                ...
                <div class="col-md-6 pt-md-0 pt-4 " style="direction: rtl">
                    <h3 class="right"> شيءٌ  <span class="text_y">جميل</span><br> سيكون هنا قريباً  <br>
                        ...
                        <div class="form__group field">
                            ...
                            <label for="name" class="form__label">اسم الشركة   </label>
                          </div>


                        <div class="form__group field">
                           
                            <input type="email" class="form__field" placeholder="Name" name="email" id='name' required />
                            <label for="name" class="form__label">البريد الإلكتروني </label>
                          </div>

                          <div class="form__group field">
                            <input type="" class="form__field" placeholder="Name" name="password" id='name' required />
